...
class LineChallenge extends Challenge 
{
  LineChallenge() {
    id = "line";
    title = "Line";
    desc = "Povezite vse atome v crto.";
    desc2 = "Potrebna reakcija je ze zagotovljena, zato samo povlecite atome na svoje mesto.";
...
class JoinChallenge extends Challenge {
  JoinChallenge() { 
    id = "join";
    title = "Join";
    desc = "Povezite vse atome skupaj.";
    desc2 = "Za resitev tega izziva boste morali dodati eno ali vec reakcij. Pritisnite gumb '+' in nato kliknite reakcijo, da jo uredite.";
    min_reactions_required = 1;
  }
  void init()
  {
...
class SurroundChallenge extends Challenge {
  SurroundChallenge() { 
    id = "surround";
    title = "Surround";
    desc = "Povezite sest rdecih atomov neposredno z rumenim atomom.";
    min_reactions_required = 1;
  }
  void init()
  {
...
class PairsChallenge extends Challenge {
  PairsChallenge() {
    id = "pairs";
    title = "Pairs";
    desc = "Povezite vse atome v rdece-zelene pare.";
    desc2 = "(Morali boste spremeniti njihove stevilke.)";
    min_reactions_required = 1;
  }
  void init() 
  {
...
class BreakOutChallenge extends Challenge {
  BreakOutChallenge() {
    id = "breakout";
    title = "Break out";
    desc = "Povezite rdece in vijolicne atome skupaj.";
...
class LinkChallenge extends Challenge {
  LinkChallenge() {
    id = "link";
    title = "Link";
    desc = "Naredite verigo, da povezete dva fiksna atoma.";
    min_reactions_required = 2;
  }
  void init()
  {
...
class BuildLadderChallenge extends Challenge {
  BuildLadderChallenge() {
    id = "build_ladder";
    title = "Zgradi lestev";
    desc = "Zgradite preostali del lestve.";
    min_reactions_required = 2;
  }
  void init()
  {
...
class SignalChallenge extends Challenge {
  SignalChallenge() {
    ...
    desc2 = "Ne sklepajte ali prekinjajte nobenih vezi.";
    min_reactions_required = 1;
  }
  void init()
  {
...
class AssemblyChallenge extends Challenge { // compare with how clathrin works
  AssemblyChallenge() {
    id = "assembly";
    title = "Assembly";
    desc = "Povezite ujemajoce se oznake stanja 0, da sestavite strukturo.";
...
class CopyingChallenge extends Challenge {
  CopyingChallenge() {
    id = "copying";
    title = "Copying";
    desc = "Na vsak atom v verigi povezite eno ujemajoco se barvo.";
    min_reactions_required = 3;
  }
  void init()
  {
...
class ExtendChallenge extends Challenge {
  ExtendChallenge() {
    id = "extend";
    title = "Extend";
    desc = "Prekinite nekaj vezi, da podaljsate verigo dovolj dalec, da povezete dva zelena atoma skupaj.";
...
class SqueezeChallenge extends Challenge { // (not currently using this one)
  SqueezeChallenge() {
    id = "squeeze";
    title = "Squeeze";
    desc = "Z vlecenjem zelenega atoma po rumeni stezi stisnite rdece atome skupaj.";
    desc2 = "";
  }
  void init() 
  {
...
class RainbowChallenge extends Challenge {
  RainbowChallenge() {
    id = "rainbow";
    title = "Mavricne vreige";
    desc = "Povezite atome v pet mavrinih verig.";
    desc2 = "Vsaka veriga mora biti sestavljena iz sestih atomov: rdeci, rumeni, zeleni, svetlo modri, temno modri, vijolicni, v tem vrstnem redu.";
    min_reactions_required = 5;
  }
  void init() 
  {
...
class FitChallenge extends Challenge {
  FitChallenge() {
    id = "fit";
    title = "Fit";
    desc = "Oba dela zlepite skupaj, da naredite popoln sesterokotnik, pri cemer bodo vse vezi nedotaknjene.";
