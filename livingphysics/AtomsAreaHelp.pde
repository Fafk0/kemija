...
void showAtomsAreaHelp()
{
  ...
  String text_block1 = "To so "atomi", ki poskakujejo v dvodimenzionalnem svetu. Lahko jih povlecete s prstom.\n\n"+
    "Atomi so lahko ena od sestih vrst in imajo 'stanje' - stevilo 0-9, ki se lahko spreminja.\n\n"+
    "Atomi se lahko vezejo na druge ali pa se ne vezejo. Vezava in spreminjanje stanja se zgodita z 'reakcijami'.\n\n"+
    "Do reakcije pride, ko trcita dva atoma z ustrezno barvo in stanjem. Zadnja reakcija je prikazana na dnu zaslona.\n\n"+
    "Vasa naloga je urejanje reakcij, da se stvari zgodijo. Pritisnite gumb zobnika, da vidite trenutni izziv in uredite reakcije.\n\n"+
    "Ravne je pogosto mogoce resiti z dodajanjem vec reakcij po potrebi in pazljivim vlecenjem stvari na svoje mesto, vendar najelegantnejse resitve vkljucujejo malo reakcij in se ne zanasajo na vlecenje.";
