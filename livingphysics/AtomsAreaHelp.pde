...
void showAtomsAreaHelp()
{
  ...
  String text_block1 = "To so "atomi", ki poskakujejo v dvodimenzionalnem svetu. Lahko jih povlecete s prstom.\n\n"+
    ...
    "Ravni je pogosto mogoce resiti z dodajanjem vec reakcij po potrebi in pazljivim vlecenjem stvari na svoje mesto, vendar najelegantnejse resitve vkljucujejo malo reakcij in se ne zanasajo na vlecenje.";
