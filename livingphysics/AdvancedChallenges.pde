...
class LadderFromRungsChallenge extends Challenge {
  LadderFromRungsChallenge() {
    id = "rungs";
    title = "Precke";
    desc = "Sestavite lestev s pomocjo prilozenih preck.";
    desc2 = "Ali lahko to storite, ne da bi se zanasali na to, da boste atome potegnili na svoje mesto?";
    min_reactions_required = 4;
  }
  void init()
  ...
  void detectCheating()
  {
    ...
    for(int i=0;i<atoms.length;i+=2)
    {
      ...
      {
        cheating_detected = true;
        cheating_message = "Precke morajo biti ves cas nedotaknjene. Poskusi ponovno.";
        return;
      }
    }
  }
...
class MatchChallenge extends Challenge {
  MatchChallenge() {
    ...
    desc2 = "Ne da bi spremenili stanja robnih atomov ali prekinili par, povecajte vsak atom para z njegovo ujemajoco se barvo na robu.";
    min_reactions_required = 8;
  }
  void init()
  {
