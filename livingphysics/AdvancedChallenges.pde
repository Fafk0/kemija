...
class InsertChallenge extends Challenge {
  ...
  void detectCheating()
  {
    ...
    if(chain.size()<10) {
      ...
      cheating_message = "Veriga naj bo ves cas nedotaknjena. Poskusi ponovno.";
    }
  }
}
...
class ZipChallenge extends Challenge {
  ZipChallenge() {
    id = "zip";
    title = "Spni";
    desc = "Oba pramena spnite skupaj, da dokoncate lestev.";
    min_reactions_required = 2;
  }
  void init()
  {
...
class MessagePassingChallenge extends Challenge {
  MessagePassingChallenge() {
    id = "message_passing";
    title = "Message";
    desc = "Brez pretrganja vezi pritrdite modre atome na vsak konec iste zelene verige.";
    desc2 = "Ali lahko to storite, ne da bi se zanasali na to, da boste atome potegnili na svoje mesto?";
  ...
  void detectCheating()
  {
    for(int i=0;i<reactions.size();i++)
    {
      ...
      {
        cheating_detected = true;
        cheating_message = "Reakcije, ki trgajo vezi, v tem izzivu niso dovoljene. Poskusi ponovno.";
        return;
      }
    }
  }
...
class GrowMembraneChallenge extends Challenge {
  GrowMembraneChallenge() {
    id = "grow_membrane";
    title = "Povecaj zanko";
    desc = "Povecajte zanko z dodajanjem ohlapnih rumenih atomov in dajte vsebini vec prostora za premikanje.";
    desc2 = "Ne izpustite rdecih atomov!";
    min_reactions_required = 3;
  }
  void init()
  {
...
class PullingChallenge extends Challenge {
  PullingChallenge() {
    id = "pull";
    title = "Povleci";
    desc = "Povlecite rdeci atom po stezi, da ga povezete z zelenim atomom.";
    desc2 = "Ohrani vez nedotaknjeno.";
    min_reactions_required = 4;
  }
  void init()
  {
  ...
  void detectCheating()
  {
    ...
    for(int i=1;i<atoms.length;i++)
    {
      ...
      {
        cheating_detected = true;
        cheating_message = "Naj bo steza ves cas nedotaknjena. Poskusi ponovno.";
        return;
      }
    }
    ...
    for(int i=0;i<atoms.length;i++)
    {
      if(atoms[i].type==0)
      {
        ...
        cheating_detected = true;
        cheating_message = "Rdeci atom mora biti ves cas neposredno pritrjen na stezo. Poskusi ponovno.";
        return;
      }
    }
  }
...
class ConcertinaChallenge extends Challenge {
  ConcertinaChallenge() {
    id = "concertina";
    title = "Koncetrirana";
    desc = "Zlozite verigo skupaj in jo povezite v nosilec, kot je spodnji del.";
    min_reactions_required = 4;
  }
  void init()
  {
  ...
  void detectCheating()
  {
    ...
    {
      cheating_detected = true;
      cheating_message = "Veriga naj bo ves cas povezana v enem kosu. Poskusi ponovno.";
      return;
    }
  }
  void evaluateSuccess()
...
class LadderFromRungsChallenge extends Challenge {
  LadderFromRungsChallenge() {
    id = "rungs";
    title = "Vezi";
    desc = "Sestavite lestev s pomocjo prilozenih vezmi.";
    desc2 = "In to storite, ne da bi se zanasali na to, da boste atome potegnili na svoje mesto?";
    min_reactions_required = 4;
  }
  void init()
  {
  ...
  void detectCheating()
  {
    ...
    for(int i=0;i<atoms.length;i+=2)
    {
      ...
      {
        cheating_detected = true;
        cheating_message = "Vezi morajo biti ves cas nedotaknjene. Poskusi ponovno.";
        return;
      }
    }
  }
...
class RollChallenge extends Challenge {
  RollChallenge() {
    id = "roll";
    title = "Zavrti";
    desc = "Rdece trikotnike zavrtite na nasprotna konca steze.";
    desc2 = "Naj tir in trikotniki ostanejo nedotaknjeni, trikotniki pa naj bodo povezani s tirom.";
    min_reactions_required = 4;
  }
  void init()
  {
  ...
  void detectCheating()
  {
    ...
    for(int i=0;i<4;i++)
    {
      ...
      {
        cheating_detected = true;
        cheating_message = "Rdeci trikotniki naj bodo ves cas nedotaknjeni. Poskusi ponovno.";
        return;
      }
    }
    // track intact?
    ...
    {
      cheating_detected = true;
      cheating_message = "Rdeci trikotniki naj bodo ves cas povezani z modro stezo. Poskusi ponovno.";
      return;
    }
  }
}
...
class FilterChallenge extends Challenge {
  FilterChallenge() {
    id = "filter";
    title = "Filter";
    desc = "Premaknite vse rdece in zelene atome na razlicne strani verige.";
    desc2 = "Ali lahko to storite, ne da bi se zanasali na to, da boste atome potegnili na svoje mesto?";
  ...
  void detectCheating()
  {
    ...
    {
      cheating_detected = true;
      cheating_message = "Veriga naj bo ves cas povezana. Poskusi ponovno.";
      return;
    }
  }
}
...
class PeristalsisChallenge extends Challenge {
  PeristalsisChallenge() {
    ...
    title = "Peristaltika";
    desc = "
Z odpiranjem in zapiranjem 'preck' premaknite zeleni atom navzdol skozi modro cev v spodnje obmocje in ga povezite z rdecim atomom.";
    desc2 = "Hkrati ne smejo biti odprte vec kot 3 stopnice. (Odprti sta ze 2 precki.)";
  ...
  void detectCheating()
  {
      ...
      case 3: // tube wall
        {
          ...
          {
            cheating_detected = true;
            cheating_message = "Stene modre cevi morajo ostati nedotaknjene. Poskusi ponovno.";
            return;
          }
    ...
    {
      cheating_detected = true;
      cheating_message = "Naenkrat ne smejo biti odprte vec kot 3 'stopnice'. Poskusi ponovno.";
      return;
    }
  }
}
...
class EatChallenge extends Challenge {
  EatChallenge() {
    ...
    desc2 = "Ne izpustite rdecega atoma.";
...
class MatchChallenge extends Challenge {
  MatchChallenge() {
    id = "match";
    title = "Match";
    desc = "Ne da bi spremenili stanja robnih atomov ali prekinili par, povezite vsak atom para z njegovo ujemajoco se barvo na robu.";
    desc2 = "Ali ga lahko pripravite do zanesljivega delovanja, ne da bi morali atome povleci na svoje mesto?";
    min_reactions_required = 8;
  }
  void init()
  {
  ...
  void detectCheating()
  {
    for(int i=0;i<atoms.length-2;i++)
    {
      if(atoms[i].state!=0) {
        cheating_detected = true;
        cheating_message = "Atomi na robovih morajo imeti ves cas stanje 0. Poskusi ponovno.";
        return;
      }
    }
    ...
    {
      cheating_detected = true;
      cheating_message = "Par atomov mora ostati vezan. Poskusi ponovno.";
      return;
    }
  }
}
...
class MitosisChallenge extends Challenge {
  MitosisChallenge() {
    id = "mitosis";
    title = "Mitosis";
    desc = "Zanko razdelite na dve loceni zanki. Zadrzi rdece atome v sebi.";
    desc2 = "Ce zelite, lahko uporabite dva atoma stanja 2.";
    min_reactions_required = 8;
  }
  void init() 
  {
  ...
  void detectCheating()
  {
    ...
    {
      cheating_detected = true;
      cheating_message = "Dva rdeca atoma naj ostaneta notri. Poskusi ponovno.";
      return;
    }
  }
}
