...
class PullingChallenge extends Challenge {
  PullingChallenge() {
    ...
    desc2 = "Ohrani progo nedotaknjeno.";
    min_reactions_required = 4;
  }
  void init()
  {
...
class PeristalsisChallenge extends Challenge {
  PeristalsisChallenge() {
    id = "peristalsis";
    title = "Peristaltika";
    desc = "Z odpiranjem in zapiranjem 'preck' premaknite zeleni atom navzdol skozi modro cev v spodnje obmocje in ga povezite z rdecim atomom.";
...
class MitosisChallenge extends Challenge {
  MitosisChallenge() {
    ...
    desc2 = "Zanko razdelite na dve loceni zanki. Zadrzi rdece atome v sebi.";
    min_reactions_required = 8;
  }
  void init() 
  {
