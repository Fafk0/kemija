...
void showSettingsHelp()
{
  ...
  if(iChallenge==0)
    ...
    text_block1 = "Ta plosca prikazuje trenutni izziv in reakcije.\n\n"+
      "Plosco lahko povlecete gor in dol, ce vsa vsebina ni vidna.\n\n"+
      "V razdelku 'Odzivi' lahko kliknete na reakcijo, da jo uredite, na voljo pa sta tudi dva gumba: za brisanje vseh reakcij (prosil za potrditev) in za dodajanje nove reakcije.\n\n"+
      "Na dnu je gumb za odlozisce, ki vam omogoca spreminjanje ravni, ce se zataknete ali se zelite vrniti na prejsnji izziv.\n\n"+
      "Gumb za vnovicno nalaganje vam omogoca, da znova zazenete trenutni izziv (prosil vas bo za potrditev), pri cemer ohranite reakcije, kot so.\n\n"+
      "Panel (in tega) lahko opustite s kljukico.";
